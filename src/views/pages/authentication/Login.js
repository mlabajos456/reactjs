        ...
        <Col className='d-flex align-items-center auth-bg px-2 p-lg-5' lg='4' sm='12'>
          <Col className='px-xl-2 mx-auto' sm='8' md='6' lg='12'>
            <CardTitle tag='h2' className='font-weight-bold mb-1'>
              Bienvenido a NutriciónLab! 👋
            </CardTitle>
            <CardText className='mb-2'>Por favor ingrese sus credenciales</CardText>
            <Alert color='primary'>
            ...
            <AvForm className='auth-login-form mt-2' onSubmit={handleSubmit}>
              ...
              <FormGroup>
                <CustomInput type='checkbox' className='custom-control-Primary' id='remember-me' label='Recordarme' />
              </FormGroup>
